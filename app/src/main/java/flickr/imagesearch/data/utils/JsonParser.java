    ...
    public static FlickrApiResponse deserializeFlickrApiResponse(String data)
    {
        ...
        try
        {
            ...
            for(int i=0; i<array.length(); i++)
            {
                ...
                photoList.add(new Photo(id, owner, secret, server, farm, title, ispublic, isfriend, isfamily));
            }

            flickrApiResponse = new FlickrApiResponse(page, pages, perpage, total, photoList);
        }
